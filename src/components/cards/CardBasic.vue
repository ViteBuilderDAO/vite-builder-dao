  ...
  <div>
    <v-row>
      ...
      >
        <v-card>
          <v-img
            src="@/assets/img/pages/card-basic-influencer.png"
            height="250"
          />
          <v-card-title>
            Influencing The Influencer
      ...
      >
        <v-card>
          <v-img
            ...
            src="@/assets/img/pages/card-basic-person.png"
            height="250"
          />
          <v-card-text class="position-relative">
            ...
            <v-avatar
              ...
              class="avatar-center"
            >
              <v-img src="@/assets/img/avatars/1.png"></v-img>
            </v-avatar>
            ...
            <div class="d-flex justify-space-between align-center mt-8">
              ...
              <v-avatar size="40">
                <v-img src="@/assets/img/avatars/2.png"></v-img>
              </v-avatar>
            </div>
          </v-card-text>
        </v-card>
          ...
          <div class="d-flex justify-space-between flex-wrap flex-md-nowrap flex-column flex-md-row">
            <div class="mx-auto">
              <v-img
                width="220"
                height="100%"
                src="@/assets/img/pages/card-basic-mobile.png"
              ></v-img>
            </div>
      ...
      >
        <v-card>
          <div class="d-flex flex-column-reverse flex-md-row">
            ...
            <div class="pa-4">
              <v-img
                src="@/assets/img/pages/card-basic-clock.jpg"
      ...
      >
        <v-card>
          <v-img src="@/assets/img/pages/card-basic-brown-watch.jpg"></v-img>
      ...
      >
        <v-card color="text-center">
          ...
          <v-card-text>
            It is a very common occurrence to have placeholder text depending upon your lifestyle.
          </v-card-text>
          <v-card-text>
            <v-btn
              color="primary"
